...
ERR_NOT_IMPLEMENTED = <int><int>cef_types.ERR_NOT_IMPLEMENTED
ERR_CONNECTION_CLOSED = <int><int>cef_types.ERR_CONNECTION_CLOSED
ERR_CONNECTION_RESET = <int><int>cef_types.ERR_CONNECTION_RESET
ERR_CONNECTION_REFUSED = <int><int>cef_types.ERR_CONNECTION_REFUSED
ERR_CONNECTION_ABORTED = <int><int>cef_types.ERR_CONNECTION_ABORTED
ERR_CONNECTION_FAILED = <int><int>cef_types.ERR_CONNECTION_FAILED
ERR_NAME_NOT_RESOLVED = <int><int>cef_types.ERR_NAME_NOT_RESOLVED
ERR_INTERNET_DISCONNECTED = <int><int>cef_types.ERR_INTERNET_DISCONNECTED
ERR_SSL_PROTOCOL_ERROR = <int><int>cef_types.ERR_SSL_PROTOCOL_ERROR
