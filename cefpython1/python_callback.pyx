...
# We call it through V8FunctionHandler's detructor, see v8function_handler.h > ~V8FunctionHandler().
# "with gil" must be added as we call it from c++.
cdef void RemovePythonCallback(int callbackID) except * with gil:
