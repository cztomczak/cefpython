...
class Request:
    Flags = {
        "None": cef_types.WUR_FLAG_NONE,
        "SkipCache": cef_types.WUR_FLAG_SKIP_CACHE,
        "AllowCachedCredentials": cef_types.WUR_FLAG_ALLOW_CACHED_CREDENTIALS,
        "AllowCookies": cef_types.WUR_FLAG_ALLOW_COOKIES,
        "ReportUploadProgress": cef_types.WUR_FLAG_REPORT_UPLOAD_PROGRESS,
        "ReportLoadTiming": cef_types.WUR_FLAG_REPORT_LOAD_TIMING,
        "ReportRawHeaders": cef_types.WUR_FLAG_REPORT_RAW_HEADERS,
    }
...
cdef class PyRequest:
    ...
    cpdef py_void SetFlags(self, int flags):
        self.GetCefRequest().get().SetFlags(
                <cef_types.cef_weburlrequest_flags_t?>flags)
