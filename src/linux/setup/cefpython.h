...
__PYX_EXTERN_C DL_IMPORT(bool) RequestHandler_OnBeforePluginLoad(CefRefPtr<CefBrowser> , CefString const &, CefString const &, bool, CefString const &, CefRefPtr<CefWebPluginInfo> , cef_plugin_policy_t *);
